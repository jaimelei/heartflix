    ...
    return (
        <>
            ...
            >
                            ...
                            className={({ isActive }) =>
                                [
                                    ...
                                    isActive
                                        ...
                                        : "text-[var(--color-text-primary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-alt)]",
                                ].join(" ")
                            }
                        >
                            {label}
                ...
                {/* right — explore catalog CTA + hamburger */}
                <div className="ml-auto flex items-center gap-3">
                    ...
                    >
                        ...
                        />
                        <span
                            className="block w-3.5 h-[1.5px] rounded-full self-start ml-[3px]"
                            style={{ background: "var(--color-text-primary)" }}
                        />
                    </button>
                </div>
